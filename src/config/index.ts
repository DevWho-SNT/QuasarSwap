...
// Modified, 15 secs for every new Nova block
export const BSC_BLOCK_TIME = 15

export const BASE_EXPLORER_SCAN_URLS = {
  [ChainId.MAINNET]: 'https://explorer.novanetwork.io',
  [ChainId.TESTNET]: 'https://nova-testnet.tryethernal.com',
}
...
export const CAKE_PER_BLOCK = 0.25
export const BLOCKS_PER_YEAR = (60 / BSC_BLOCK_TIME) * 60 * 24 * 365 // 2102400
export const CAKE_PER_YEAR = CAKE_PER_BLOCK * BLOCKS_PER_YEAR
export const BASE_URL = 'https://quasarswap.net'
export const BASE_ADD_LIQUIDITY_URL = `${BASE_URL}/add`
export const BASE_EXPLORER_SCAN_URL = BASE_EXPLORER_SCAN_URLS[ChainId.MAINNET]

...
import { CurrencyAmount, JSBI, Token, Trade } from '@quasarswap/sdk'
import {
  Button,
  Text,
  ArrowDownIcon,
...
export default function Swap() {
  ...
  return (
    <Page removePadding={isChartExpanded} hideFooterOnDesktop={isChartExpanded}>
      <Flex flexDirection="column" width="100%" justifyContent="center" position="relative">
              ...
              <AppBody>
                ...
                <Wrapper id="swap-page">
                    ...
                    {showWrap ? null : (
                      <AutoColumn gap="7px" style={{ padding: '0 16px' }}>
                        ...
                        <RowBetween align="center">
                          <LabelIcon>
                            {t('Slippage')}
                            <GlobalSettings color="textSubtle" mr="0" iconPencil={true} />
                          </LabelIcon>
                  ...
                  <Flex justifyContent="center" mt="1rem">
                    <AutoRow id="swap-action-btn" justify="center" style={{ padding: '0 1rem' }}>
                      {swapIsUnsupported ? (
                        ...
                        <Button width="50%" disabled={Boolean(wrapInputError)} onClick={onWrap}>
                          {wrapInputError ??

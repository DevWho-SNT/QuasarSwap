...
import { Currency, currencyEquals, ETHER, Percent, WETH } from '@quasarswap/sdk'
...
export default function RemoveLiquidity() {
  ...
  return (
    <Page>
      <AppBody>
        ...
        <CardBody>
          <AutoColumn gap="20px">
            ...
            {!showDetailed && (
              <BorderCard>
                <Text fontSize="25px" bold style={{ lineHeight: 1 }}>
                  ...
                  {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                    <RowBetween style={{ justifyContent: 'flex-end', fontSize: '14px' }}>
                      {oneCurrencyIsETH ? (
                        ...
                        <StyledInternalLink
                          href={`/remove/${
                            currencyA && currencyEquals(currencyA, WETH[chainId]) ? 'SNT' : currencyIdA
                          }/${currencyB && currencyEquals(currencyB, WETH[chainId]) ? 'SNT' : currencyIdB}`}
                        >
                          {t('Receive SNT')}
                        </StyledInternalLink>
                      ) : null}
      ...
      {pair ? (
        <AutoColumnStyled style={{ minWidth: '20rem', width: '200px', maxWidth: '400px', marginLeft: '24px' }}>

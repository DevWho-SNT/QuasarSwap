...
export interface ActionPanelProps {
  ...
  details: FarmWithAvailableValue
...
const ActionPanel: React.FunctionComponent<ActionPanelProps> = ({
  ...
  const { earningToken, collection } = farm
  const lpLabel = farm.colSymbol && farm.colSymbol.toUpperCase().replace('PANCAKE', '')
  const liquidityUrlPathParts = getLiquidityUrlPathParts({
    quoteTokenAddress: earningToken.address,

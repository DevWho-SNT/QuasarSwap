...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and QSR pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and QSR pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from QSR pool', data)
  }

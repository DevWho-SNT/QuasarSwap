...
import { Currency, currencyEquals, ETHER, TokenAmount, WETH } from '@quasarswap/sdk'
  ...
  const handleCurrencyBSelect = useCallback(
    (currencyB_: Currency) => {
      ...
      if (currencyIdA === newCurrencyIdB) {
        ...
        router.replace(`/add/${currencyIdA || 'SNT'}/${newCurrencyIdB}`, undefined, { shallow: true })
      }
    },
        ...
        <MaxWidthCard>
          ...
          {!addIsUnsupported ? (
            pair && !noLiquidity && pairState !== PairState.INVALID ? (
              <AutoColumn style={{ minWidth: '20rem', width: '100%', maxWidth: '400px', marginLeft: '24px' }}>

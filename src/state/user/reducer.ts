...
export interface UserState {
  ...
  userNFTFarmStakedOnly: NFTFarmStakedOnly
...
export const initialState: UserState = {
  ...
  userNFTFarmStakedOnly: NFTFarmStakedOnly.ON_FINISHED,
...
export default createReducer(initialState, (builder) =>
  builder
    ...
    .addCase(updateUserNFTFarmStakedOnly, (state, { payload: { userNFTFarmStakedOnly } }) => {
      state.userNFTFarmStakedOnly = userNFTFarmStakedOnly
    })

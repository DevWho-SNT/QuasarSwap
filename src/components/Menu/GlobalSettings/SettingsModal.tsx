...
import { Text, QuasarToggle, Toggle, Flex, Modal, InjectedModalProps, ThemeSwitcher } from '@pancakeswap/uikit'
import {
  useAudioModeManager,
    ...
    >
      <ScrollableContainer>
        ...
        {/*<Flex justifyContent="space-between" alignItems="center">
          ...
          <QuasarToggle checked={audioPlay} onChange={toggleSetAudioMode} scale="md" />
          </Flex>*/}
      </ScrollableContainer>
    </Modal>
  )

...
import pulsar from 'config/abi/pulsar.json'
...
export const getPulsarContract = (signer?: Signer | Provider) => {
  return getContract(pulsar, getPulsarAddress(), signer) as Pulsar
}

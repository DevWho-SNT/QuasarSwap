...
import { ChainId, JSBI, Percent, Token, CurrencyAmount, Currency, ETHER } from '@quasarswap/sdk'
...
export function getBscScanLinkForNft(
  ...
  return `${BASE_EXPLORER_SCAN_URLS[chainId]}/token/${collectionAddress}?a=${tokenId}`
}

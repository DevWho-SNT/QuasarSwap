/**
 * @see https://github.com/quasarswap/quasar-frontend/blob/develop/src/config/constants/tokens.ts
 */
const tokens = {
  cake: {
    symbol: "CAKE",
    ...
    decimals: 18,
    projectLink: "https://quasarswap.net/",
  },
  txl: {
    symbol: "TXL",
    address: {
  ...
  bunny: {
    ...
    decimals: 18,
    projectLink: "https://quasarbunny.finance/",
  },
  alice: {
    symbol: "ALICE",
    address: {
  ...
  syrup: {
    symbol: "SYRUP",
    address: {
      56: "0xABa735cc7A4C4d3936d4790775e4192347933E80",
      97: "0xABa735cc7A4C4d3936d4790775e4192347933E80",
    },
    decimals: 18,
    projectLink: "https://quasarswap.net/",
  },

...
import QuasarProfileSdk from "./profile-sdk";
...
describe("QuasarProfileSdk", () => {
  describe("constructor", () => {
    ...
    it("uses custom provider instance if specified", () => {
      ...
      const sdk = new QuasarProfileSdk({ provider: customProvider });
      expect(sdk.provider).toBe(customProvider);
    });
    it("uses specific chainId if chainId is provided", () => {
      const sdk = new QuasarProfileSdk({ chainId: TESTNET_CHAIN_ID });
    ...
    describe("getProfile", () => {
      ...
      it("sets cookies", async () => {
        ...
        expect(Cookies.set).toBeCalledWith(
          ...
          {
            username: "Cheems",
            avatar: `https://quasarswap.net/images/nfts/${sleepyNft.images.sm}`,
          },

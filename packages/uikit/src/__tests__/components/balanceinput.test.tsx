...
it("renders correctly with unit prop and switchEditingUnits", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c9:hover:not(:disabled):not(.quasar-button--disabled):not(.quasar-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c9:active:not(:disabled):not(.quasar-button--disabled):not(.quasar-button--disabled) {
      opacity: 0.85;

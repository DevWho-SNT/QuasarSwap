...
const Nfts: Nft[] = [
  ...
  {
    name: "Sunny",
    description: "Sunny is always cheerful when there are quasars around. Smile!",
    images: {
      lg: "sunny-lg.png",
      md: "sunny-md.png",
      sm: "sunny-sm.png",
  ...
  {
    name: "Blueberries",
    description: "These bunnies like their quasars with blueberries. What's your favorite topping?",
    images: {
  ...
  {
    name: "Circular",
    description: "Love makes the world go 'round... but so do quasars. And these bunnies know it.",
    images: {
      lg: "circular-lg.png",
      md: "circular-md.png",
      sm: "circular-sm.png",
  ...
  {
    name: "Sparkle",
    description: "It’s sparkling syrup, quasars, and even lottery tickets! This bunny really loves it.",
    images: {
      lg: "sparkle-lg.png",
      md: "sparkle-md.png",
      sm: "sparkle-sm.png",
